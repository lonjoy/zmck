                    ...
                    <div class="login-wrap-content clearfix">
                                        ...
                                        <ul class="login-box">
                                            ...
                                            <li class="login-input js-row">
                                                <div class="form-input-wrapper js-inputItem">
                                                    <label class="text-gray js-usernameLabel" >邮箱或手机</label>
                        ...
                        <div class="registerwrap">
                            <div class="login-wrap-form registerwrap">
                                ...
                                <form data-log="ursLogin" action="#" method="POST" id="Form2" name="Form2" autocomplete="off" target="_self">
                                    <div>
                                        <ul class="login-box">
                                            <li class="login-error">
                                                <span class="text-icon-tips js-tips hidden"></span>
                                            ...
                                            <li>
                                                <ul class="list-radio">
                                                    <li>
                                                        <label>
                                                            <input type="radio" name="state" value="1" checked />找项目参与创业</label></li>
                                                    <li>
                                                        <label>
                                                            <input type="radio" name="state" value="2" />有项目主导创业</label></li>
                                                    <li>
                                                        <label>
                                                            <input type="radio" name="state" value="3" />开放心态 </label></li>
                                                   
                                                </ul>
                                            </li>
                                            <li class="login-btnBox" style="margin-top:15px; ">
                                                <a class="login-btn submit-trigger" onClick="return false;" href="javascript:;">创建账号</a>
                                            </li>
