...
/**
 * 分页类
 * @author  zhuyuxiang zhuyuxiang@haibian.com
 * @version $Id: ListPageComponent.php 1192 2014-03-14 19:10:09Z zhuyuxiang $
 * 分页样式 
...
class ListPageComponent extends Component{
    ...
    protected function show_1() {
        ...
        $return = '';
        $return .= '<li>'.$this->first_page ().'</li>';
        $return .= '<li>'.$this->up_page ().'</li>';
        ...
        $return .= '<li>'.$this->down_page().'</li>';
        $return .= '<li>'.$this->last_page ().'</li>';
        return $return;
    }
